...
@section('content')
    ...
    <section class="relative flex items-center justify-between w-full gap-5 wrapper">
        ...
        <p class="absolute text-base font-semibold translate-x-1/2 -translate-y-1/2 top-1/2 right-1/2">Shopping Carts</p>
    </section>
    ...
    <section class="wrapper flex flex-col gap-2.5">
        <div class="flex items-center justify-between">
            ...
            <button type="button" class="p-2 bg-white rounded-full" data-expand="itemsList">
                <img src="{{asset('img/ic-chevron.svg')}}" class="transition-all duration-300 -rotate-180 size-5" alt="">
            </button>
        </div>
        <div class="flex flex-col gap-4" id="itemsList">
            ...
            <div class="py-3.5 pl-4 pr-[22px] bg-white rounded-2xl flex gap-1 items-center relative">
                <img src="{{asset('img/product-2.webp')}}" class="w-full max-w-[70px] max-h-[70px] object-contain"
                     alt="">
                <div class="flex flex-wrap items-center justify-between w-full gap-1">
                    ...
                    <button type="button">
                        <img src="{{asset('img/ic-trash-can-filled.svg')}}" class="size-[30px]" alt="">
                    </button>
                </div>
            </div>
        </div>
    ...
    <section class="wrapper flex flex-col gap-2.5">
        <div class="flex items-center justify-between">
            ...
            <button type="button" class="p-2 bg-white rounded-full" data-expand="__detailsPayment">
                <img src="{{asset('img/ic-chevron.svg')}}" class="transition-all duration-300 size-5" alt="">
            </button>
        </div>
    ...
    <section class="wrapper flex flex-col gap-2.5">
        ...
        <div class="grid items-center grid-cols-2 gap-4">
            <label
                ...
                <img src="{{asset('img/ic-receipt-text-filled.svg')}}" alt="">
            ...
            <label class="relative rounded-2xl bg-white flex gap-2.5 px-3.5 py-3 items-center justify-start has-[:checked]:ring-2 has-[:checked]:ring-primary transition-all">
                ...
                <img src="{{asset('img/ic-card-filled.svg')}}" alt="">
        ...
        <div class="p-4 mt-0.5 bg-white rounded-3xl hidden" id="manualPaymentDetail">
            <div class="flex flex-col gap-5">
                ...
                <div class="inline-flex items-center gap-2.5">
                    <img src="{{asset('img/ic-bank.svg')}}" class="size-5" alt="">
                    <p class="text-base font-semibold">Send Payment to</p>
                </div>
                <div class="inline-flex items-center gap-2.5">
                    <img src="{{asset('img/ic-security-card.svg')}}" class="size-5" alt="">
        ...
        <form action="" method="" class="p-6 bg-white rounded-3xl" id="deliveryForm">
            <div class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-2.5">
                    ...
                    <input type="text" name="address" id="address__" class="form-input" style="background-image: url('{{asset('img/ic-location.svg')}}')" value="Tedjamudita 3">
                </div>
                <!-- City -->
                <div class="flex flex-col gap-2.5">
                    <label for="city" class="text-base font-semibold">City</label>
                    <input type="text" name="city" id="city__" class="form-input" style="background-image: url('{{asset('img/ic-map.svg')}}')" value="Bolavia">
                </div>
                <!-- Post Code -->
                <div class="flex flex-col gap-2.5">
                    <label for="postcode" class="text-base font-semibold">Post Code</label>
                    <input type="number" name="postcode" id="postcode__" class="form-input" style="background-image: url('{{asset('img/ic-house.svg')}}')" value="22081882">
                </div>
                <!-- Phone Number -->
                <div class="flex flex-col gap-2.5">
                    <label for="phonenumber" class="text-base font-semibold">Phone Number</label>
                    <input type="number" name="phonenumber" id="phonenumber__" class="form-input" style="background-image: url('{{asset('img/ic-phone.svg')}}')" value="602192301923">
                </div>
                <!-- Add. Notes -->
                <div class="flex flex-col gap-2.5">
                    <label for="notes" class="text-base font-semibold">Add. Notes</label>
                    <span class="relative">
              <img src="{{asset('img/ic-edit.svg')}}" class="absolute size-5 top-4 left-4" alt="">
              <textarea name="notes" id="notes__"
                ...
                <div class="flex flex-col gap-2.5">
                    ...
                    <input type="file" name="proof_of_payment" id="proof_of_payment__" class="form-input" style="background-image: url('{{asset('img/ic-folder-add.svg')}}')">
                </div>
            </div>
        </form>
    </section>
    ...
    <div class="fixed z-50 bottom-[30px] bg-black rounded-3xl p-5 left-1/2 -translate-x-1/2 w-[calc(100dvw-32px)] max-w-[425px]">
        <section class="flex items-center justify-between gap-5">
            ...
            <button type="button" class="inline-flex items-center justify-center px-5 py-3 text-base font-bold text-white rounded-full w-max bg-primary whitespace-nowrap" onclick="window.location.href='/public/pages/success-checkout.html'">Confirm</button>
        </section>
    </div>
@endsection
